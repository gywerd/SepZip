...
With following instructions you can easily integrate PeaZip with Gnome and KDE, but please note those same instructions and sample scripts can be adapted to any DE following FreeDesktop guidelines:

1) Extract PeaZip portable to the desired path and link peazip binary where desired (even network, removable, or cloud paths), or in one of the system's binary folder i.e. /bin, /sbin, /usr/bin, or /usr/local/bin
